...
class MainWindow:
    ...
    def widgets(self):
        ...
        self.uppercase = tk.Checkbutton(self.optionsFrame, text="Uppercase Letter", onvalue=1, offvalue=0, variable=self.val)
        ...
        self.optionsFrame.grid(row=0, column=0) # Options and Length beside each other
        self.lengthFrame.grid(row=0, column=1)  # Options and Length beside each other
